import{d as o,r as x,j as e,S as b,I as C,L as v,T as w,a as g,C as f,P as M,b as j,c as k,e as I,f as y,g as A,h as G,i as F,M as W,k as S,l as a,m as c,n as T,o as P}from"./Servicios-M0BWP4NE.js";const z=o.nav`
  font-family:outfit;
  display: flex;
...
`,D=()=>{const[r,s]=x.useState(!1),n=u=>{const h=document.getElementById(u);h&&h.scrollIntoView({behavior:"smooth"})},d=()=>{window.scrollTo({top:0,behavior:"smooth"})},t=()=>{s(!r)};return e.jsxs(z,{children:[e.jsx(E,{onClick:d,src:"/logo.svg",alt:"Logo"}),e.jsxs(L,{children:[e.jsx(l,{onClick:()=>n("Productos"),children:"Productos"}),e.jsx(l,{onClick:()=>n("Servicios"),children:"Servicios"}),e.jsx(l,{onClick:()=>n("Contacto"),children:"Contacto"})]}),e.jsx(U,{onClick:t,"aria-label":r?"Cerrar menú":"Abrir menú","aria-expanded":r,"aria-controls":"mobile-menu",children:"☰"}),e.jsx(B,{id:"mobile-menu",isOpen:r,children:e.jsxs(O,{children:[e.jsx(l,{onClick:()=>{n("Productos"),t()},children:"Productos"}),e.jsx(l,{onClick:()=>{n("Servicios"),t()},children:"Servicios"}),e.jsx(l,{onClick:()=>{n("Contacto"),t()},children:"Contacto"})]})})]})},R=o.button`
...
text-decoration: none;
width: 100%;
`,te=()=>{const r=s=>{const n=document.getElementById(s);n&&n.scrollIntoView({behavior:"smooth"})};return e.jsxs(e.Fragment,{children:[e.jsxs(se,{children:[e.jsxs(p,{children:[e.jsx(m,{children:"Mapa de sitio"}),e.jsx(i,{onClick:()=>r("Productos"),children:"Productos"}),e.jsx(i,{onClick:()=>r("servicios"),children:"Servicios"}),e.jsx(i,{onClick:()=>r("Contacto"),children:"Contacto"})]}),e.jsxs(p,{children:[e.jsx(m,{children:"Contactanos"}),e.jsx(i,{href:"tel:+525621288935",children:"Telefono"}),e.jsx(i,{href:"mailto:contacto@uniformesar.com",children:"Correo"}),e.jsx(i,{href:"https://www.facebook.com/profile.php?id=61584467946957",children:"Facebook"})]}),e.jsxs(p,{children:[e.jsx(m,{children:"Horarios"}),e.jsx(i,{as:"div",style:{cursor:"default"},children:"Lunes a Viernes"}),e.jsx(i,{as:"div",style:{cursor:"default"},children:"9:00 am a 2:00 pm"})]})]}),e.jsx(ie,{href:"https://wa.me/+525649770838",children:"Desarrollado por: Daniel Flores - 2026"})]})};function ae(){return e.jsxs(e.Fragment,{children:[e.jsx(D,{}),e.jsx("section",{id:"Inicio",children:e.jsx(V,{})}),e.jsx("section",{id:"Productos",children:e.jsx(ee,{})}),e.jsx("section",{id:"Servicios",children:e.jsx(T,{})}),e.jsx("section",{id:"Contacto",children:e.jsx(ne,{})}),e.jsx("section",{id:"Contacto",children:e.jsx(te,{})})]})}P(document.getElementById("root")).render(e.jsx(x.StrictMode,{children:e.jsx(ae,{})}));
