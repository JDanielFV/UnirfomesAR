import{u as o,r as x,j as e,S as b,I as v,L as C,T as w,a as g,C as f,P as M,b as j,c as k,d as I,e as y,f as A,g as G,h as F,M as W,i as S,k as a,l as c,m as T,n as P}from"./Servicios-aBlSoq-R.js";const z=o.nav`
  font-family:outfit;
  display: flex;
...
`,N=()=>{const r=document.getElementById("Productos");r&&r.scrollIntoView({behavior:"smooth"})},V=()=>e.jsx(e.Fragment,{children:e.jsxs(b,{children:[e.jsxs(v,{children:[e.jsx(C,{src:"/icono.svg",alt:"Logo"}),e.jsxs(w,{children:[e.jsx(g,{children:"Uniformes A&R"}),e.jsx(f,{children:"Con más de 18 años de experiencia que nos respaldan siendo lideres en la manofactura de uniformes industriales, escolares, ejecutivos, hospitalarios, etc. Complementando con los servicios de bordado, serigrafía, y vinil textil, entre otros."})]})]}),e.jsx(R,{onClick:N,children:e.jsx("img",{src:"./Bajar.svg"})})]})}),q=o.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
