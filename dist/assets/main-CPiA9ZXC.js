import{d as o,r as p,j as e,S as b,I as C,L as v,T as w,a as m,C as f,P as M,b as j,c as I,e as k,f as A,g as y,h as G,i as F,M as W,k as S,l,m as d,n as T,o as P}from"./Servicios-M0BWP4NE.js";const z=o.nav`
  font-family:outfit;
  display: flex;
...
`,D=()=>{const[r,s]=p.useState(!1),n=u=>{const x=document.getElementById(u);x&&x.scrollIntoView({behavior:"smooth"})},c=()=>{window.scrollTo({top:0,behavior:"smooth"})},i=()=>{s(!r)};return e.jsxs(z,{children:[e.jsx(E,{onClick:c,src:"/logo.svg",alt:"Logo"}),e.jsxs(U,{children:[e.jsx(t,{onClick:()=>n("Productos"),children:"Productos"}),e.jsx(t,{onClick:()=>n("Servicios"),children:"Servicios"}),e.jsx(t,{onClick:()=>n("Contacto"),children:"Contacto"})]}),e.jsx(B,{onClick:i,children:"☰"}),e.jsx(L,{isOpen:r,children:e.jsxs(O,{children:[e.jsx(t,{onClick:()=>{n("Productos"),i()},children:"Productos"}),e.jsx(t,{onClick:()=>{n("Servicios"),i()},children:"Servicios"}),e.jsx(t,{onClick:()=>{n("Contacto"),i()},children:"Contacto"})]})})]})},R=o.button`
